...
1. **Why Neuchâtel:** Precision manufacturing lives on spindle uptime and scrap avoidance. I built a cell-health board that speaks vibration / temperature / current, not generic ops dashboards.
